...
Config.TruckPrice	= 30       -- config antiga do script original não usado nesta versão.
Config.Locale       = 'br'   -- Traduções disponivel br/en
Config.BagPay       = 25     -- Pague por sacola puxada do lixo.
Config.MulitplyBags = true   -- Multiplica BagPay pelo número de trabalhadores - 4 máx.

Config.Trucks = {
	"trash",
	"trash2",
	--"biff",  --levou este veículo para fora por razões estéticas. Tentando encontrar animação que funciona jogando o lixo no caminhão.
	--"scrap"
}
